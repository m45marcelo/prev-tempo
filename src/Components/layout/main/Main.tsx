        ...
        <main className="flex w-full flex-col gap-9">
            <div className="flex h-[200px] w-full relative justify-between">
                <div className="flex items-center">
                    <h3 className="text-[116px] font-light text-white">{weatherCurrent?.data[0].temp}</h3>

                    <div className="h-[84px] flex items-end ml-8">
                    <ul className="h-14">
                        <li className="text-[20px] font-medium text-white">°C | F</li>
                        <li className="text-[20px] font-medium text-white">{weatherCurrent?.data[0].weather.description}</li>
                    </ul>
                    </div>
                </div>

                <img alt="imagem icon" src={weatherCurrent?.data[0].weather.icon} width={200} className="absolute bottom-[2.125rem] right-32"/>
                ...
                <div className="h-[12.5rem] flex items-center">
                    ...
                    <ul className="leading-7">
                        <li className="flex">
                            ...
                            <span className="text-[0.875rem] font-normal text-white">Feels like: 25°C</span>
                        </li>
                        <li className="flex">
                            <img alt="Umidade" src={humidadeIcon} height={20} width={20} className="mr-2"/>
                            <span className="text-[0.875rem] font-normal text-white">Humidity: 59%</span>
                        </li>
                        <li className="flex">
                            <img alt="Vento" src={ventoIcon} height={20} width={20} className="mr-2"/>
                            <span className="text-[0.875rem] font-normal text-white">Wind: 2km/h</span>
                        </li>
                    </ul>
                    </div>
                </div>
